...
public interface StackStrategy {
	...
	/**
	 * Returns a list of Cards which can be played on top of the provided top card.
	 * 
	 * @param topCard the top card on a stack
	 * @return a list of Cards which can be played on top of the provided top card
	 */
	public List<Card> cardsThatCanBePlayed(Card topCard);
	
	/**
	 * Return <tt>true</tt> if the stack is complete, that is, can't accept anymore Cards based on the provided top card; <tt>false</tt>, otherwise.
	 * 
	 * @return <tt>true</tt> if the stack is complete, that is, can't accept anymore Cards based on the provided top card; <tt>false</tt>, otherwise
	 */
